...
;( function( window ) {
	...
	grid3D.prototype._init = function() {
		...
		// grid element
		this.grid = this.gridWrap.querySelector( 'div.grids' );
		// main grid items
		...
		// content
		this.contentEl = this.el.querySelector( 'div.displaycontent' );
		// content items
	...
	grid3D.prototype._hideContent = function() {
		var self = this,
			contentItem = this.el.querySelector( 'div.displaycontent > .show' ),
	...
	*/
	grid3D.prototype._createPlaceholder = function( displaycontent ) {
		var front = document.createElement( 'div' );
		front.className = 'front';
		front.innerHTML = displaycontent;
